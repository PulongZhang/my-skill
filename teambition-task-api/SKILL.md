...
用户从 Git 提交或日报发起补录时，先用 `daily-work-summary` 提取并客观归纳实际工作，再把结果作为候选计划交给本 skill。交接内容至少包含日期、实际工作说明、候选任务 ID/标题、项目/SFC 和拟登记时长；提交记录不能直接视为 Teambition 写入授权，也不能仅凭提交信息夸大工作性质。

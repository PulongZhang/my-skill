...
用法：
    uv run --project ~/.claude/skills/sshops python ~/.claude/skills/sshops/scripts/ssh_download.py <alias> <remote_path> <local_path> [options]

示例：
    # 下载单个文件
    uv run --project ~/.claude/skills/sshops python ~/.claude/skills/sshops/scripts/ssh_download.py prod-web-01 /var/log/app.log ./app.log

    # 断点续传
    uv run --project ~/.claude/skills/sshops python ~/.claude/skills/sshops/scripts/ssh_download.py prod-web-01 /tmp/large-file.iso ./large-file.iso --resume

    # 下载整个目录
    uv run --project ~/.claude/skills/sshops python ~/.claude/skills/sshops/scripts/ssh_download.py prod-web-01 /var/log/ ./logs/ --recursive

    # 下载目录 + 断点续传
    uv run --project ~/.claude/skills/sshops python ~/.claude/skills/sshops/scripts/ssh_download.py prod-web-01 /opt/data/ ./data/ --recursive --resume
"""
